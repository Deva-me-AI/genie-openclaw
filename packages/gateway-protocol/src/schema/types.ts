...
export type ChannelsPairingListParams = SchemaType<"ChannelsPairingListParams">;
export type ChannelsPairingApproveParams = SchemaType<"ChannelsPairingApproveParams">;
